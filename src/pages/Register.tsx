...
export default function Register() {
  ...
  return (
    <>
      ...
      <p className="text-slate-500 text-sm mb-6">Join Wayve to unlock smart parking insights</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start gap-2">
          <input type="checkbox" id="terms" className="mt-0.5 rounded border-slate-300 text-blue-600 focus:ring-blue-500" required />
